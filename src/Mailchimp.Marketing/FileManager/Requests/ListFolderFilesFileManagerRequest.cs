...
[Serializable]
public record ListFolderFilesFileManagerRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public ListFolderFilesFileManagerRequestSortField? SortField { get; set; }

    /// <summary>
    /// Determines the order direction for sorted results.
    /// </summary>
    [JsonIgnore]
    public ListFolderFilesFileManagerRequestSortDir? SortDir { get; set; }
