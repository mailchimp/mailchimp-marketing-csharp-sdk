...
/// </summary>
[Serializable]
public record ListFoldersFileManagerResponseFoldersItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<ListFoldersFileManagerResponseFoldersItemLinksItem>? Links { get; set; }
