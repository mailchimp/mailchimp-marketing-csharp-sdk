...
public partial class TemplatesClient : ITemplatesClient
{
    ...
    /// </summary>
    private WithRawResponseTask<ListTemplatesResponse> ListInternalAsync(
        ListTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListTemplatesResponse>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<ListTemplatesResponse>> ListInternalAsyncCore(
        ListTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListTemplatesResponse>(responseBody)!;
                return new WithRawResponse<ListTemplatesResponse>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<TemplateInstance>> CreateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<TemplateInstance>(responseBody)!;
                return new WithRawResponse<TemplateInstance>()
                {
                    Data = responseData,
                    RawResponse = new Mailchimp.Marketing.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<TemplateInstance>> GetAsyncCore(
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    ...
                    Path = string.Format(
                        "3.0/templates/{0}",
                        ValueConvert.ToPathParameterString(request.TemplateId)
                    ),
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
    ...
    private async Task<WithRawResponse<TemplateInstance>> UpdateAsyncCore(
    ...
    private async Task<
        WithRawResponse<ListDefaultContentTemplatesResponse>
    > ListDefaultContentAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    Method = HttpMethod.Get,
                    Path = string.Format(
                        "3.0/templates/{0}/default-content",
                        ValueConvert.ToPathParameterString(request.TemplateId)
                    ),
                    QueryString = _queryString,
                    Headers = _headers,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListDefaultContentTemplatesResponse>(
                    responseBody
                )!;
                return new WithRawResponse<ListDefaultContentTemplatesResponse>()
                {
                    Data = responseData,
                    RawResponse = new Mailchimp.Marketing.RawResponse()
                    {
    ...
    /// </code></example>
    public async Task<Pager<TemplateInstance>> ListAsync(
        ListTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        >
            .CreateInstanceAsync(
                ...
                null,
                response => response.Templates?.ToList(),
                null,
                cancellationToken
            )
            .ConfigureAwait(false);
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<TemplateInstance> CreateAsync(
        CreateTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<TemplateInstance>(
    ...
    /// </code></example>
    public WithRawResponseTask<TemplateInstance> GetAsync(
        GetTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask<TemplateInstance> UpdateAsync(
        UpdateTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ListDefaultContentTemplatesResponse> ListDefaultContentAsync(
        ListDefaultContentTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListDefaultContentTemplatesResponse>(
            ListDefaultContentAsyncCore(request, options, cancellationToken)
        );
    }
}
