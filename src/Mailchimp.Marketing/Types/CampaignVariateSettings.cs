...
/// </summary>
[Serializable]
public record CampaignVariateSettings : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<CampaignVariateSettingsCombinationsItem>? Combinations { get; set; }
    ...
    public required CampaignVariateSettingsWinnerCriteria WinnerCriteria { get; set; }
