...
/// </summary>
[Serializable]
public record SegmentTypeItemIpGeoInZip : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required SegmentTypeItemIpGeoInZipField Field { get; set; }

    /// <summary>
    /// Segment members who are within a specific US zip code.
    /// </summary>
    [JsonPropertyName("op")]
    public required SegmentTypeItemIpGeoInZipOp Op { get; set; }
