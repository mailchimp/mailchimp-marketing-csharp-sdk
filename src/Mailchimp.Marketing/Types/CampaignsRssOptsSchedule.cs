...
/// </summary>
[Serializable]
public record CampaignsRssOptsSchedule : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CampaignsRssOptsScheduleDailySend? DailySend { get; set; }
    ...
    public CampaignsRssOptsScheduleWeeklySendDay? WeeklySendDay { get; set; }
