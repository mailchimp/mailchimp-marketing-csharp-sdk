...
/// </summary>
[Serializable]
public record CampaignsVariateSettings : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<CampaignsVariateSettingsCombinationsItem>? Combinations { get; set; }
    ...
    public CampaignsVariateSettingsWinnerCriteria? WinnerCriteria { get; set; }
