...
/// </summary>
[Serializable]
public record AudiencesContactSmsChannelEffectiveSubscriptionStatus : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AudiencesContactSmsChannelEffectiveSubscriptionStatusValue? Value { get; set; }
