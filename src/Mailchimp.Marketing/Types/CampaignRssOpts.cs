...
/// </summary>
[Serializable]
public record CampaignRssOpts : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CampaignRssOptsFrequency Frequency { get; set; }
    ...
    public CampaignRssOptsSchedule? Schedule { get; set; }
