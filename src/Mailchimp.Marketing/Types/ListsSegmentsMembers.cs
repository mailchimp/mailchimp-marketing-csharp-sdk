...
/// </summary>
[Serializable]
public record ListsSegmentsMembers : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<ListsSegmentsMembersLinksItem>? Links { get; set; }
    ...
    public ListsSegmentsMembersLastNote? LastNote { get; set; }
    ...
    public ListsSegmentsMembersLocation? Location { get; set; }
    ...
    public Dictionary<
        string,
        OneOf<ListsSegmentsMembersMergeFieldsValueAddr1, string, double>
    >? MergeFields { get; set; }
    ...
    public ListsSegmentsMembersStats? Stats { get; set; }

    /// <summary>
    /// Subscriber's current status.
    /// </summary>
    [JsonPropertyName("status")]
    public ListsSegmentsMembersStatus? Status { get; set; }
