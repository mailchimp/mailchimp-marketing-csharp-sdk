...
public record Campaign : IJsonOnDeserialized
{
    ...
    public IEnumerable<CampaignLinksItem>? Links { get; set; }
    ...
    public CampaignRssOpts? RssOpts { get; set; }
    ...
    public CampaignSocialCard? SocialCard { get; set; }
    ...
    public CampaignVariateSettings? VariateSettings { get; set; }
