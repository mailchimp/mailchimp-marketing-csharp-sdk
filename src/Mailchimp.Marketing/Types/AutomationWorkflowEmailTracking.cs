...
/// </summary>
[Serializable]
public record AutomationWorkflowEmailTracking : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AutomationWorkflowEmailTrackingCapsule? Capsule { get; set; }
    ...
    public AutomationWorkflowEmailTrackingSalesforce? Salesforce { get; set; }
