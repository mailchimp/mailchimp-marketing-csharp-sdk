...
/// </summary>
[Serializable]
public record AutomationWorkflowTriggerSettings : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AutomationWorkflowTriggerSettingsRuntime? Runtime { get; set; }
    ...
    public required AutomationWorkflowTriggerSettingsWorkflowType WorkflowType { get; set; }
