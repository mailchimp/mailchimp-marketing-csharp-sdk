...
/// </summary>
[Serializable]
public record AbuseComplaint : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<AbuseComplaintLinksItem>? Links { get; set; }
    ...
    public Dictionary<
        string,
        OneOf<AbuseComplaintMergeFieldsValueAddr1, string, double>
    >? MergeFields { get; set; }
