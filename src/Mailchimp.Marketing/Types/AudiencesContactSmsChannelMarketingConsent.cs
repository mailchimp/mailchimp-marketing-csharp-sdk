...
/// </summary>
[Serializable]
public record AudiencesContactSmsChannelMarketingConsent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AudiencesContactSmsChannelMarketingConsentSource? Source { get; set; }
    ...
    public AudiencesContactSmsChannelMarketingConsentStatus? Status { get; set; }
