...
/// </summary>
[Serializable]
public record AudiencesContactEmailChannelEffectiveSubscriptionStatus : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AudiencesContactEmailChannelEffectiveSubscriptionStatusValue? Value { get; set; }
