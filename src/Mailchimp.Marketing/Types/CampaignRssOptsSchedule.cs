...
/// </summary>
[Serializable]
public record CampaignRssOptsSchedule : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CampaignRssOptsScheduleDailySend? DailySend { get; set; }
    ...
    public CampaignRssOptsScheduleWeeklySendDay? WeeklySendDay { get; set; }
