...
/// </summary>
[Serializable]
public record FacebookAdsAudience : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public FacebookAdsAudienceEmailSource? EmailSource { get; set; }
    ...
    public FacebookAdsAudienceSourceType? SourceType { get; set; }

    [JsonPropertyName("targeting_specs")]
    public FacebookAdsAudienceTargetingSpecs? TargetingSpecs { get; set; }

    /// <summary>
    /// Type of the audience
    /// </summary>
    [JsonPropertyName("type")]
    public FacebookAdsAudienceType? Type { get; set; }
