...
/// </summary>
[Serializable]
public record CreateCampaignsRequestRssOptsSchedule : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreateCampaignsRequestRssOptsScheduleDailySend? DailySend { get; set; }
    ...
    public CreateCampaignsRequestRssOptsScheduleWeeklySendDay? WeeklySendDay { get; set; }
