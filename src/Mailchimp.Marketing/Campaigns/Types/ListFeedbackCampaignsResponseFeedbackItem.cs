...
/// </summary>
[Serializable]
public record ListFeedbackCampaignsResponseFeedbackItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<ListFeedbackCampaignsResponseFeedbackItemLinksItem>? Links { get; set; }
    ...
    public ListFeedbackCampaignsResponseFeedbackItemSource? Source { get; set; }
