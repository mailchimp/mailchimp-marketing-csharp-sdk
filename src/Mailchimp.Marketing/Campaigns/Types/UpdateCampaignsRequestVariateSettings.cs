...
/// </summary>
[Serializable]
public record UpdateCampaignsRequestVariateSettings : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public UpdateCampaignsRequestVariateSettingsWinnerCriteria? WinnerCriteria { get; set; }
