...
public record CreateListsRequest
{
    ...
    public required CreateListsRequestCampaignDefaults CampaignDefaults { get; set; }

    /// <summary>
    /// [Contact information displayed in campaign footers](https://mailchimp.com/help/about-campaign-footers/) to comply with international spam laws.
    /// </summary>
    [JsonPropertyName("contact")]
    public required CreateListsRequestContact Contact { get; set; }
    ...
    public required bool EmailTypeOption { get; set; }
    ...
    public required string PermissionReminder { get; set; }
