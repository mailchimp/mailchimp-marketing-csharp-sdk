...
[Serializable]
public record CreateMemberListsRequest
{
    /// <summary>
    ...
    public CreateMemberListsRequestLocation? Location { get; set; }

    /// <summary>
    /// The marketing permissions for the subscriber.
    /// </summary>
    [JsonPropertyName("marketing_permissions")]
    public IEnumerable<CreateMemberListsRequestMarketingPermissionsItem>? MarketingPermissions { get; set; }
    ...
    public Dictionary<
        string,
        OneOf<CreateMemberListsRequestMergeFieldsValueAddr1, string, double>
    >? MergeFields { get; set; }
    ...
    public required CreateMemberListsRequestStatus Status { get; set; }
    ...
    public OneOf<string, CreateMemberListsRequestTimestampOptOne>? TimestampOpt { get; set; }

    [JsonPropertyName("timestamp_signup")]
    public OneOf<string, CreateMemberListsRequestTimestampSignupOne>? TimestampSignup { get; set; }
