...
[Serializable]
public record UpdateMemberListsRequest
{
    /// <summary>
    ...
    public UpdateMemberListsRequestLocation? Location { get; set; }

    /// <summary>
    /// The marketing permissions for the subscriber.
    /// </summary>
    [JsonPropertyName("marketing_permissions")]
    public IEnumerable<UpdateMemberListsRequestMarketingPermissionsItem>? MarketingPermissions { get; set; }
    ...
    public Dictionary<
        string,
        OneOf<UpdateMemberListsRequestMergeFieldsValueAddr1, string, double>
    >? MergeFields { get; set; }
    ...
    public UpdateMemberListsRequestStatus? Status { get; set; }

    [JsonPropertyName("timestamp_opt")]
    public OneOf<string, UpdateMemberListsRequestTimestampOptOne>? TimestampOpt { get; set; }

    [JsonPropertyName("timestamp_signup")]
    public OneOf<string, UpdateMemberListsRequestTimestampSignupOne>? TimestampSignup { get; set; }
