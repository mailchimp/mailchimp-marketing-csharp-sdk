...
/// </summary>
[Serializable]
public record CreateSignupFormListsRequestHeader : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreateSignupFormListsRequestHeaderImageAlign? ImageAlign { get; set; }
    ...
    public CreateSignupFormListsRequestHeaderImageBorderStyle? ImageBorderStyle { get; set; }
    ...
    public CreateSignupFormListsRequestHeaderImageTarget? ImageTarget { get; set; }
