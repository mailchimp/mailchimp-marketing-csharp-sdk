...
[Serializable]
public record CreateAudienceContactRequestSmsChannel : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreateAudienceContactRequestSmsChannelMarketingConsent? MarketingConsent { get; set; }
