...
[Serializable]
public record CreateAudienceContactRequestEmailChannel : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreateAudienceContactRequestEmailChannelMarketingConsent? MarketingConsent { get; set; }
