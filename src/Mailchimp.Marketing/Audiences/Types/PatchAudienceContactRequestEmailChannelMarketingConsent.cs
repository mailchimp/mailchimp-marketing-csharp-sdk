...
/// </summary>
[Serializable]
public record PatchAudienceContactRequestEmailChannelMarketingConsent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public PatchAudienceContactRequestEmailChannelMarketingConsentSource? Source { get; set; }

    [JsonPropertyName("status")]
    public PatchAudienceContactRequestEmailChannelMarketingConsentStatus? Status { get; set; }
