...
/// </summary>
[Serializable]
public record PatchAudienceContactRequestSmsChannelMarketingConsent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public PatchAudienceContactRequestSmsChannelMarketingConsentSource? Source { get; set; }
    ...
    public PatchAudienceContactRequestSmsChannelMarketingConsentStatus? Status { get; set; }
