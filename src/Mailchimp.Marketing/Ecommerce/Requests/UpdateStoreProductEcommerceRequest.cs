...
[Serializable]
public record UpdateStoreProductEcommerceRequest
{
    /// <summary>
    /// The store id.
    /// </summary>
    ...
    public IEnumerable<UpdateStoreProductEcommerceRequestImagesItem>? Images { get; set; }
    ...
    public IEnumerable<UpdateStoreProductEcommerceRequestVariantsItem>? Variants { get; set; }
