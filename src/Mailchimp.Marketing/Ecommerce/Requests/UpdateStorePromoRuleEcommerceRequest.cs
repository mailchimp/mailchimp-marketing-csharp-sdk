...
[Serializable]
public record UpdateStorePromoRuleEcommerceRequest
{
    /// <summary>
    /// The store id.
    /// </summary>
    ...
    public OneOf<double, string>? Amount { get; set; }
    ...
    public UpdateStorePromoRuleEcommerceRequestTarget? Target { get; set; }
    ...
    public UpdateStorePromoRuleEcommerceRequestType? Type { get; set; }
