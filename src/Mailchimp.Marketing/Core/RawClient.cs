...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::Mailchimp.Marketing.Core.ApiResponse> SendRequestAsync(
        global::Mailchimp.Marketing.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::Mailchimp.Marketing.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::Mailchimp.Marketing.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::Mailchimp.Marketing.Core.BaseRequest request)
    {
