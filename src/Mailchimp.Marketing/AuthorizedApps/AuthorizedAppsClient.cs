...
public partial class AuthorizedAppsClient : IAuthorizedAppsClient
{
    private readonly RawClient _client;

    internal AuthorizedAppsClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private WithRawResponseTask<ListAuthorizedAppsResponse> ListInternalAsync(
        ListAuthorizedAppsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListAuthorizedAppsResponse>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<ListAuthorizedAppsResponse>> ListInternalAsyncCore(
        ListAuthorizedAppsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListAuthorizedAppsResponse>(responseBody)!;
                return new WithRawResponse<ListAuthorizedAppsResponse>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<GetAuthorizedAppsResponse>> GetAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetAuthorizedAppsResponse>(responseBody)!;
                return new WithRawResponse<GetAuthorizedAppsResponse>()
                {
                    Data = responseData,
                    RawResponse = new Mailchimp.Marketing.RawResponse()
                    {
    ...
    /// </code></example>
    public async Task<Pager<ListAuthorizedAppsResponseAppsItem>> ListAsync(
        ListAuthorizedAppsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask<GetAuthorizedAppsResponse> GetAsync(
        GetAuthorizedAppsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetAuthorizedAppsResponse>(
