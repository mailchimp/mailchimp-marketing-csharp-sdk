...
public partial class CampaignFoldersClient : ICampaignFoldersClient
{
    private readonly RawClient _client;

    internal CampaignFoldersClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private WithRawResponseTask<CampaignFolders> ListInternalAsync(
        ListCampaignFoldersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CampaignFolders>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<CampaignFolders>> ListInternalAsyncCore(
        ListCampaignFoldersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<CampaignFolders>(responseBody)!;
                return new WithRawResponse<CampaignFolders>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<CampaignFolders>> CreateAsyncCore(
    ...
    private async Task<WithRawResponse<GetCampaignFoldersResponse>> GetAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetCampaignFoldersResponse>(responseBody)!;
                return new WithRawResponse<GetCampaignFoldersResponse>()
                {
                    Data = responseData,
                    RawResponse = new Mailchimp.Marketing.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<UpdateCampaignFoldersResponse>> UpdateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<UpdateCampaignFoldersResponse>(
                    responseBody
                )!;
                return new WithRawResponse<UpdateCampaignFoldersResponse>()
                {
                    Data = responseData,
                    RawResponse = new Mailchimp.Marketing.RawResponse()
                    {
    ...
    /// </code></example>
    public async Task<Pager<CampaignFoldersFoldersItem>> ListAsync(
        ListCampaignFoldersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask<CampaignFolders> CreateAsync(
        CreateCampaignFoldersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask<GetCampaignFoldersResponse> GetAsync(
        GetCampaignFoldersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetCampaignFoldersResponse>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<UpdateCampaignFoldersResponse> UpdateAsync(
        UpdateCampaignFoldersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<UpdateCampaignFoldersResponse>(
