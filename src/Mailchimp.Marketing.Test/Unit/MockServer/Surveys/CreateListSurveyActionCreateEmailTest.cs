...
public class CreateListSurveyActionCreateEmailTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/3.0/lists/list_id/surveys/survey_id/actions/create-email")
                    .UsingPost()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Surveys.CreateListSurveyActionCreateEmailAsync(
