...
public class UpdateStoreOrderTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/3.0/ecommerce/stores/store_id/orders/order_id")
        ...
        var response = await Client.Ecommerce.UpdateStoreOrderAsync(
