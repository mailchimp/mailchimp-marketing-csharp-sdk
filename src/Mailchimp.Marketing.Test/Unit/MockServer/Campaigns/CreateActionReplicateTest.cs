...
public class CreateActionReplicateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/3.0/campaigns/campaign_id/actions/replicate")
                    .UsingPost()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Campaigns.CreateActionReplicateAsync(
